...
const FixedImage = () => {
  ...
  return (
    <div
      className={` w-full h-[60vh] md:h-[80vh]  bg-[linear-gradient(to_right_bottom,rgba(30,0,160,0.8),rgba(8,8,8,0.8)),url('home.jpeg')]  homepage bg-cover bg-no-repeat flex items-center justify-center p-4`}
    >
      <Navbar />
